          ...
          <div className="p-6 sm:p-8 bg-white border border-slate-200 rounded-xl hover:border-slate-300 transition-all">
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm">
              <li className="flex items-center gap-2 text-slate-700">
                <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-slate-600 flex-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <ul className="space-y-2.5 sm:space-y-3 text-xs sm:text-sm">
              {[
                ...
                <li key={item} className="flex items-center gap-2 text-neutral-700">
                  <svg className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-[#D4AF37] flex-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M5 13l4 4L19 7" />
                  </svg>
                  <span>{item}</span>
                </li>
